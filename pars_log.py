	...
	html_cpu = ""
        ...
        with open(_pwd_ +  "/" + el, "rb") as log_f:
                ...
                for line in log_f:
					...
					html_cpu = html_cpu + "<tr><td>" + date_ + " " + time_ + "</td><td>" + hn_ + "</td><td>" + "CPU:" + var1  + "</td><td>" + var2 + "</td><td>" + var_per_val_usage + "</td></tr>\n"
...
for el in a:
	    ...
	    html = html + "<h3>" + l_n + "</h3>\n"
            ...
            html = html + "<tr><td>Date </td><td>Server Name</td><td>Target status</td><td>Status</td><td>Usage Value%</td></tr>\n"
